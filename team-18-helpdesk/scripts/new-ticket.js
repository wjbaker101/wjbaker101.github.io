...
window.addEventListener('load', () =>
{
    ...
    const specialistCheckbox = document.querySelector('.assign-specialist-checkbox');
    ...
    newTicketButton.addEventListener('click', () =>
    {
        ...
        const problemDescription = document.querySelector('.full-description-input').value;
        ...
        if (window.location.hash)
        {
            ...
            ticketDatabase.child('logs').push(log).then(() =>
            {
        ...
        {
            database.push(newTicket).child('logs').push(log).then(() =>
            {
                window.location.href = 'helpdesk.html';
            });
        }
